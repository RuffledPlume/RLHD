...
public final class PrimitiveFloatArray {
	public float[] array = new float[16];
	public int length;

	public PrimitiveFloatArray reset() {
		length = 0;
		return this;
	}

	public PrimitiveFloatArray ensureCapacity(int count) {
	...
	public void put(float[] floats, int offset, int count) {
		ensureCapacity(count);
		arraycopy(floats, offset, array, length, count);
		length += count;
	}
