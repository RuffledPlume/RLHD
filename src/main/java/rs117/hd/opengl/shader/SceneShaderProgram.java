...
import static rs117.hd.HdPlugin.TEXTURE_UNIT_SCENE;
...
public class SceneShaderProgram extends ShaderProgram {
	...
	protected final UniformTexture uniSceneOpaque= addUniformTexture("sceneOpaque");
	...
	protected void initialize() {
		...
		uniSceneOpaque.set(TEXTURE_UNIT_SCENE);
