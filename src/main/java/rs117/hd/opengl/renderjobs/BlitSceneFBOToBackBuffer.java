...
public class BlitSceneFBOToBackBuffer extends RenderJob {
	...
	public BlitSceneFBOToBackBuffer() {super(POOL);}
	...
	public static void addToQueue(int fboScene, int fboSceneResolve, int[] sceneResolution, int[] sceneViewport, int sceneScalingModeFilter) {
